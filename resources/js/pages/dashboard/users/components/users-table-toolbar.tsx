        ...
        <div className="flex items-center justify-between">
            <div className="flex flex-1 items-center space-x-2">
                ...
                {/* {table.getColumn('type') && (
                    <DataTableFacetedFilter column={table.getColumn('type')} title="Type" options={bookTypes} />
                )} */}
                {/* {table.getColumn('status') && (
                    <DataTableFacetedFilter column={table.getColumn('status')} title="Status" options={bookStatus} />
                )} */}
                {/* {table.getColumn('approval') && (
                    <DataTableFacetedFilter
                        column={table.getColumn('approval')}
                        title="Approval"
                        options={bookApprovals}
                    />
                )} */}
                {isFiltered && (
